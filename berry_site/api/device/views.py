...
from device import DeviceCreateCommand, DeviceKind
...
def register_device(request):
    ...
    try:
        ...
        assignment.execute(user_email=user_email, device_id=device_id)

        return JsonResponse(
            data={"status": "Device assigned to User, registered but NOT VERIFIED"},
